...
import { createLocation, getLocations, getLocation, getDevices, attachDevice, getDeviceData, getPublicLocations } from "../api/locations";
...
export const getPublicLocationsQuery = () => {
    return useQuery
        ({
            ...
            queryFn: async () => await getPublicLocations(),
        })
}
