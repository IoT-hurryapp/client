				...
				<div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 lg:pb-20 mb-4">
					...
					<div className="w-fit text-center">
						...
						<p className="mt-6 text-lg  text-gray-600 dark:text-gray-400 leading-6">
							Stay informed and breathe easy with real-time air
							quality insights. Create your account, add your
							location, and get personalized alerts on pollution
							levels, ensuring a healthier environment for you and
							your loved ones
						</p>
